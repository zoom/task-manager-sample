...
ALTER TABLE "public"."sub_tasks" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE "public"."zoom_users" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."zoom_users"
    ADD CONSTRAINT "zoom_users_email_key" UNIQUE ("email");



ALTER TABLE ONLY "public"."zoom_users"
    ADD CONSTRAINT "zoom_users_pkey" PRIMARY KEY ("id");
...
CREATE POLICY "Enable delete for users based on user_id" ON "public"."projects" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "Enable insert for users based on user_id" ON "public"."projects" FOR INSERT WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable users to view their own data only" ON "public"."projects" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
GRANT ALL ON SEQUENCE "public"."sub_tasks_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."sub_tasks_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."sub_tasks_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."zoom_users" TO "anon";
GRANT ALL ON TABLE "public"."zoom_users" TO "authenticated";
GRANT ALL ON TABLE "public"."zoom_users" TO "service_role";
